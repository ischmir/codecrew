...
exports.dashboard = async function (req, res) {
    try {
        ...
        await dashboardM.portainerStacks("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywidXNlcm5hbWUiOiJjb2RlY3JldyIsInJvbGUiOjIsInNjb3BlIjoiZGVmYXVsdCIsImZvcmNlQ2hhbmdlUGFzc3dvcmQiOmZhbHNlLCJleHAiOjE3MzMzNzIyMTQsImlhdCI6MTczMzM0MzQxNCwianRpIjoiZmE4MDRmN2QtODg4NC00MzQ0LTk4ZTMtNTE0Njk0OGU5OGE5In0.fpGISoy0T48zc1kqDJgjiVNccjzPxw9AaCugQssdEyM").then(async (k) => {
            const reeeeee = []
            ...
            for (let i = 0; i < k.length; i++) {
                reeeeee.push({
                    ...
                    name: k[i].Name,
                    status: k[i].Status,
                    creationDate: new Date(k[i].CreationDate * 1000).toLocaleDateString('en-GB', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric',
                        hour: '2-digit',
                    ...
                    lastUpdate: k[i].UpdateDate == 0 ? new Date(k[i].CreationDate * 1000).toLocaleDateString('en-GB', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric',
                        hour: '2-digit',
                        minute: '2-digit',
                        second: '2-digit'
                    }).replaceAll("/", "-") : new Date(k[i].UpdateDate * 1000).toLocaleDateString('en-GB', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric',
                        hour: '2-digit',
                    ...
                    createdBy: k[i].CreatedBy,
                    template: k[i].EntryPoint,
