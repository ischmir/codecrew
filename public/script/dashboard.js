...
const modal = document.getElementById('create_stack_modal');
const btn = document.getElementById('create_stack_button');
//let btnMobile = document.getElementById("create_stack_button_mobile");
const span = document.getElementsByClassName('create_stack_model_close')[0];
...
const isAuthorAscending = true; // which order asc/desc. author of stack
...
///////////////
// filter
const superAdminRows = document.querySelectorAll('[data-role=\'superAdmin\']'); // ryder op senere.
