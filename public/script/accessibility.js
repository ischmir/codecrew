...
function highlightThemeBtn(btn) {
  const wrapper = document.querySelectorAll('.colorMode_btn');
...
function highlightModeBtn(btn) {
  const wrapper = document.querySelectorAll('.fontFamilyMode_btn');
...
function highlightFontSizeBtn(btn) {
  const wrapper = document.querySelectorAll('.fontSizeMode_btn');
...
function presetLocalStorageSelected() {
  const colorWrapper = document.querySelectorAll('.colorMode_btn');
  ...
  const modeWrapper = document.querySelectorAll('.fontFamilyMode_btn');
  const modeNameConvert = localStorage.getItem('dyslexia') == 'true' ? 'dyslexic' : 'default';
  ...
  const fontSizeWrapper = document.querySelectorAll('.fontSizeMode_btn');
...
function showAdvDyslexiaOptions() {
  const wrapper = document.querySelector('.advDyslexiaOptions_Wrapper');
...
function fontSizeChange(font) {
  ...
  if (textContent == 'small') localStorage.setItem('lineHeight', 1.4);
  if (textContent == 'medium') localStorage.setItem('lineHeight', 1.5);
  if (textContent == 'large') localStorage.setItem('lineHeight', 1.6);
...
function dyslexicMode() {
  ...
  if (!body.classList.contains('dyslexia_mode')) body.classList.add('dyslexia_mode');
}
function defaultMode() {
  localStorage.setItem('dyslexia', false);
  if (body.classList.contains('dyslexia_mode')) body.classList.remove('dyslexia_mode');
}
